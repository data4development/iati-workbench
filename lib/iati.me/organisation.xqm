...
module namespace iati-map-organisation = "http://aida.tools/map/organisation";
declare namespace iati-me = "http://aida.tools";

import module namespace org-name-to-name = "http://aida.tools/map/org-name-to-name"
  at "org-name-to-name.xqm";
import module namespace org-name-to-ref = "http://aida.tools/map/org-name-to-ref"
  at "org-name-to-ref.xqm";
import module namespace org-ref-to-ref = "http://aida.tools/map/org-ref-to-ref"
  at "org-ref-to-ref.xqm";
import module namespace org-ref-to-name = "http://aida.tools/map/org-ref-to-name"
